...
def get_default_program_arguments() -> argparse.ArgumentParser:
    ...
    bot_subparser.add_argument("--no-startup", action="store_true", default=False, help="Global logging level - probably most useful is INFO and DEBUG.", choices=LOGLEVEL_CHOICES)
