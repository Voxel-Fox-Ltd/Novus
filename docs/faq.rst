...
Example code can be found in the `examples folder <https://github.com/Voxel-Fox-Ltd/discord.py/tree/master/examples>`_
in the repository.
...
`Check the background_task.py example. <https://github.com/Voxel-Fox-Ltd/discord.py/blob/master/examples/background_task.py>`_
