...
class UserHTTPConnection:
    ...
    async def modify_current_user(self, **kwargs: Any) -> User:
        """
    ...
    async def get_current_user_guilds(
        self, *, before: int | None = None, after: int | None = None, limit: int = 200
    ) -> list[OauthGuild]:
        """
    ...
    async def get_current_user_guild_member(self, guild_id: int) -> GuildMember:
        """
    ...
    async def create_dm(self, recipient_id: int) -> Channel:
        """
    ...
    async def get_user_connections(self) -> Any:
        """
    ...
    async def get_user_application_role_connection(self, application_id: int) -> Any:
        """
    ...
    async def update_user_application_role_connection(self, application_id: int) -> Any:
        """
